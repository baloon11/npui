...
<div class="btn-group pull-right">    
  ...
  <ul class="dropdown-menu" role="menu">    
    ...
    <a data-toggle='modal' href='#modalImport' class="pull-left"          
       title="${loc.translate(_("Import Private Key"))}">         
       ${loc.translate(_("Import Private Key"))}</a>    
    </li>
% if len(wallets) > 0:     
    <li>
    <a data-toggle='modal' href='#modalListTransactions' class="pull-left"           
       title="${loc.translate(_("Transaction List"))}">         
       ${loc.translate(_("Transaction List"))}</a>    
    </li>
% endif         
    <li>
    <a data-toggle='modal' href='#createWallet' class="pull-left"          
       title="${loc.translate(_("Create a new wallet"))}">         
       ${loc.translate(_("Create a new wallet"))}</a>   
    </li>
% if len(wallets) > 0:      
    <li>
...
% if len(wallets) == 0:  
<div class="jumbotron">  
  <div align="center">  <h4>${loc.translate(_("You have no wallets yet."))}</h4>  
    <a data-toggle='modal' href='#createWallet' class="btn  btn-default"          
       title="${loc.translate(_("Create a new wallet"))}">         
       ${loc.translate(_("Create a new wallet"))}
    </a>   
  </div>      
</div>
% else:   
<table class="table table-hover">    
  <tr>      
    <td align="center"><strong>${loc.translate(_("Wallets"))}</strong></td>        
    <td align="center"><strong>${loc.translate(_("Balance for wallet"))}</strong></td>      
    <td align="center"><strong>${loc.translate(_("Address"))}</strong></td>            
    <td align="center"><strong>${loc.translate(_("Export Private Key"))}</strong></td>        
    <td align="center"><strong>${loc.translate(_("Send money"))}</strong></td>               
  </tr>
% for w in wallets:     
  <tr>      
    <td align="center">${w['wallet']}</td>      
    <td align="center">${w['balance']} ${loc.translate(_("BTC"))}</td>    
## ${w['address']} вместо ${addr} 
      ...
      <div class="modal fade" id="modalExport${w['address']}" tabindex="-1" role="dialog" aria-labelledby="modalExportLabel${w['address']}" aria-hidden="true">    
        <div class="modal-dialog" align="center">      
          <div class="modal-content">        
            ...
            <div class="modal-body" id="resp${w['address']}">  ${loc.translate(_("Wait please..."))}         
            </div>        
            <div class="modal-footer">          
              <button type="button" class="btn btn-default" data-dismiss="modal">${loc.translate(_("Close"))}
              </button>        
            ...
            ## тут POST   
              <form id="sendForm${w['address']}" class="form-inline" role="form" action="" method='POST'>  
                <div class="form-group">      
                  ...
                  <div align="right">      
                    ${loc.translate(_("Comment for recipient"))}:<span class="req">*</span>       
                    <input class="form-control"               
                           type="text"               
                           name="comment_to"              
                  ...
                  <div align="right">      
                    ${loc.translate(_("Comment for transaction"))}:<span class="req">*</span>       
                    <input class="form-control"               
                           type="text"               
                           name="comment"              
                ...
                <br />
                  <div class="pull-left">                 
                    <span class="req">*</span>${loc.translate(_("This field is optional"))}
                  </div>
            </div>        
          </div>   
