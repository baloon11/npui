...
<ol class="breadcrumb">  
  ...
  <li class="active">${loc.translate(_("Transaction List"))}
  </li>  
  <li class="active">${transaction_account}
  </li>
</ol>
##<div class="row"> 
  ##<div class="col-sm-2">
    <div align="left"><h1>${transaction_account}</h1></div>    
  ##</div>
##  <div class="col-sm-2">
##  </div>  
  ##<div class="col-sm-10">
    ...
    %if transaction_list: 
      <table class='table table-hover'>
        <tr>
          <td align="center"><strong>${loc.translate(_("Сategory of transaction"))}</strong></td>
          <td align="center"><strong>${loc.translate(_("Amount"))}</strong></td>
          <td align="center"><strong>${loc.translate(_("Other account"))}</strong></td>

          <td align="center"><strong>${loc.translate(_("Address"))}</strong></td>
          <td align="center"><strong>${loc.translate(_("Confirmation"))}</strong></td>
          <td align="center"><strong>${loc.translate(_("Transaction ID"))}</strong></td>
          <td align="center"><strong>${loc.translate(_("Message"))}</strong></td>
          <td align="center"><strong>${loc.translate(_("Message to recipient"))}</strong></td>
        </tr>   
...
##-------------------------------------------обработка ошибок------------------------------------------
      ...
      <div class="jumbotron">  
        <div align="center"> 
          <h4> ${loc.translate(_("You entered the number of transactions equal to 0."))}
          <br /> 
          <br />
      ...
      <div class="jumbotron">  
        <div align="center">
          <h4> ${loc.translate(_("With this wallet is not associated any transaction."))}
          <br /> 
          <br />
          ${loc.translate(_("Try again"))}
          <br /> 
      ...
      <div class="jumbotron">  
        <div align="center">
          <h4> ${loc.translate(_("With this wallet is not associated any transaction and you entered the number of transactions equal to 0."))}
          <br />
          <br />
          ${loc.translate(_("Try again"))}  
          <br /> 
      ...
      <div class="jumbotron">  
        <div align="center">
          <h4> ${loc.translate(_("Error in the field 'number'"))}  
          <br /> 
          <br /> 
          ${loc.translate(_("Try again"))}  
          <br /> 
...
<div class="modal fade" id="modalListTransactions"tabindex="-1" role="dialog" aria-labelledby="modalListTransactionsLabel" aria-hidden="true">         
  <div class="modal-dialog" align="center">      
    <div class="modal-content">        
      ...
      ## тут POST   
        <form id="ListTransactionsForm" class="form-inline" role="form" action="${req.route_url('bitcoin.cl.listtrans')}" method='POST'>  
          ...
          ${loc.translate(_("recent transactions"))}       
            ...
            ${loc.translate(_("Wallet name"))}:          
              ...
              % for wallet in wallets: 
                <option value="${wallet['wallet']}">${wallet['wallet']}
                </option>
              %endfor    
              </select>            
            ...
            <input type="hidden" id="csrf" name="csrf" value="${req.get_csrf()}"/>      
              <button type="submit"class="btn btn-default"                
                      name="submit" style="margin-left:1em;">
                      ${loc.translate(_("Display"))}       
              </button>
            </div>  
        </form>  
      </div>        
    ...
    <div class="modal-footer">          
      <button type="button" class="btn btn-default" data-dismiss="modal">${loc.translate(_("Close"))}
      </button>        
    </div>      
  </div>    
</div>  
